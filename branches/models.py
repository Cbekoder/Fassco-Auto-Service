...
class Wallet(models.Model):
    ...
    balance = models.DecimalField(max_digits=15, decimal_places=0, default=0, validators=[MinValueValidator(0)])
...
class Branch(models.Model):
    ...
    balance = models.DecimalField(max_digits=15, decimal_places=0, verbose_name=_('Balance'), default=0)
