...
urlpatterns = [
    ...
    path('expense-type/<int:pk>/', ExpenseTypeDetailView.as_view(), name='expense-type-detail'), # For listing and creating lendings
    path('payment-types/', ExpenseTypeListCreateView.as_view(), name='payment-type-list-create'),
    path('payment-type/<int:pk>/', ExpenseTypeDetailView.as_view(), name='payment-type-detail'),
